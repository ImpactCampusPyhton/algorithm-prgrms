...
# 다른 풀이 - itertools의 permutations 모듈 사용
## 참고: https://lynnshin.tistory.com/65
## 참고: http://naver.me/GiHdWqVh
...
def solution(expression):
    ...
    for operator in permutations(operators, 3):
        ...
        for i in expression.split(first):
            temp = [f"({j})" for j in i.split(second)]
